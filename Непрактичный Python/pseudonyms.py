...
def main():
    ...
    while True:                                    # Продолжать до тех пор, пока я не скажу остановиться
        first_name = random.choice(first)          # .choice - возвращает случайный элемент из непустой последовательности
        last_name = random.choice(last)

        print ("\n\n")
        print (f"{first_name} {last_name}") # (N.B. Далее попробовать с f-строкой)
        print("\n\n")
